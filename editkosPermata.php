...
<section id="" style="width:100%; height: 380px; background-color: #fff">
  <div class="w3-content w3-display-container">
    <?php
      ...
      $queryGambar = "SELECT nama_file FROM gambar WHERE id_gambar = 2";
...
<script>
  ...
  document.getElementById('gambarInput').addEventListener('change', function() {
    ...
    // Mengirimkan data gambar ke gambarPermata.php menggunakan AJAX
    var xhr = new XMLHttpRequest();
    xhr.open('POST', 'gambarPermata.php');
    xhr.onload = function() {
      if (xhr.status === 200) {
        // Berhasil mengupdate gambar
        alert('Gambar berhasil diupdate');
        window.location.href = 'editkosPermata.php';
      } else {
...
<section id="team" class="wow fadeInUp">
  <form method="POST" action="updatePermata.php">
    <div class="container">
        ...
        <div class="col-lg-3 col-md-6" style="background-color: #b5ffd6; padding: 15px; height: 340px">
          <div class="member">
            <div class="details">
              ...
              <br>
              <span style="font-size: 15px"><input type="text" name="alamat" placeholder="Jl. Kekalik, gang Permata No 2" style="text-align: center; border-color: #000;width: 100%"></span>
            </div>
          </div>
        </div>
      </div>
