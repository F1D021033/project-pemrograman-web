...
<body style="background-color: #f2f2f2">
  ...
  <div class="">
  <form class="form-horizontal" action="verifikasi.php" method=""  id="">
    <fieldset>
      ...
      <legend style="font-size: 39px; text-align: center;" >
        ...
        <span style=""><b>Verifikasi Akun Pemilik Kos</b></span>
      </legend>
     ...
     <!--  <div class="form-group">
      ...
      <div class=" ">
        ...
        <div style="margin-left: -40px">
          <a href="verifikasi.php"><button type="" class="btn-get-started" style="">Mulai Verifikasi</button></a>
        </div>
      </div>
