...
<title>Ganti Kata Sandi Akun FIND-KOST</title>
...
<body style="background-color: #f2f2f2">
  ...
  <div class="container" style=" width: 500px; height: 50%; margin-top: 150px; font-family: Raleway; border-color: #50d8af; border-width: 2px; background-color: #fff; border-radius: 15px">
  <div class="col-md-12">
	<br>
  ...
  <div class="">
  <form class="form-horizontal" action="../daftarkosku.php" method="post"  id="reg_form">
    <fieldset>
      
      <!-- Form Name -->
      
      <legend style="font-size: 39px; text-align: left;" >
        <a href="../loginfix/login.php"><i class="fa fa-user" style="font-size:35px;"></i></a>
        <span style="margin-left: 40px"><b>Lupa Kata Sandi</b></span>
      </legend>
    ...
    <fieldset > 
     ...
     <!--  <div class="form-group">
      ...
      <div class="form-group has-feedback">
            <label for="password"  class="col-md-4 control-label">
              Kata Sandi Baru
                ...
                <div class="col-md-6  inputGroupContainer">
                <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
            <input class="form-control" id="userPw" type="password" placeholder="Kata Sandi" 
      ...
      <div class="form-group ">
        ...
        <!-- <div >
        <a href="#" class="" style="margin-left: 75px; font-size: 12px" >Lupa kata sandi?</a>
        </div> -->
        <div class="col-md-7" style="height: 50px">
          <button type="submit" class="btn-get-started" style="margin-left: 280px;">Kirim</button>
        </div>
      </div>

      <!-- <div style="text-align: center; ">
        <legend style="font-size: 14px; padding-bottom: 10px; margin-top: -15px">Belum punya akun? <a href="signup.php" class="" ><b>Buat akun sekarang</b></a></legend>
      </div> -->
    </fieldset>
  </form>
  </div>
