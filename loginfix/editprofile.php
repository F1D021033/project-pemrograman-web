...
<title>Edit Profile FIND-KOST</title>
    ...
    <fieldset>
      ...
      <legend style="font-size: 35px; text-align: left;" >
        <h1 style="font-size: 16px; margin-top: -20px">
          ...
          <i class="fa fa-angle-double-right"></i>
          <a style="color: #50d8af;" href="#">Edit Profil</a>
        </h1>


      
        <!-- <a href="../beranda.html"><i class="fa fa-home" style="font-size:35px;"></i></a> -->
        <span style="margin-left: 180px;"><b>Edit Profil </span></b></span>
    ...
    <fieldset > 
      <div class="form-group">
        ...
        <div class="col-md-6  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input  name="first_name" value="wiya" placeholder="Nama yang udah diisi pas sign up" class="form-control"  type="text">
          </div>
        </div>
      </div>
     ...
     <!--  <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
            <input name="email" value="wiya@gmail.com" placeholder="Alamat E-Mail yang udah diisi pas sign up" class="form-control"  type="text">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input  name="last_name" value="wiya Kos" placeholder="Nama Pengguna yang udah diisi pas sign up" class="form-control"  type="text">
          </div>
        </div>
      </div>
