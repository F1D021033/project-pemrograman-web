  ...
  <div class="container">
    ...
    <div class="row" style="padding-right: 100px; padding-left: 100px">
      <div class="col-lg-9 content">
        <div class="padding-0 box-v4-alert">
          <p style="font-size: 16px"><b>Fasilitas : </b><br>
            ...
            <input type="checkbox" name="fasilitas[]" value="> WiFi<br>
          </p>
      ...
      <div class="col-lg-3 col-md-6" style="background-color: #b5ffd6; padding: 15px; height: 340px">
        <div class="member">
          <div class="details">
            <h4 style="font-size: 35px">Tersedia<br><input type="text" name="jumlah_kamar" placeholder="..." style="text-align: center; border-color: #000; width: 50px; font-size: 24px"><br>Kamar</h4>
            <hr>
            <span style="font-size: 15px"><b><input type="text" name="harga" placeholder="Harga" style="text-align: center; border-color: #000; width: 150px"> / bulan</b></span>
            <br>
            <span style="font-size: 15px"><input type="text" name="alamat" placeholder="Input Alamat" style="text-align: center; border-color: #000;width: 100%"></span>
          </div>
        </div>
      </div>
    </div>
